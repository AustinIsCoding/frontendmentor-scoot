...
const Footer = () => {
  return (
    <footer className="grid grid-cols-(--wrapper-mobile) overflow-hidden mt-30 grid-rows-[20rem_27.375rem] md:grid-cols-(--wrapper-tablet-footer) md:grid-rows-[20rem_6rem] xl:grid-cols-(--wrapper-desktop) xl:grid-rows-[18.75rem_6rem] xl:mt-[200px]">
      <div className="col-span-3 bg-(--c-dark-navy) grid grid-cols-[inherit] relative md:place-items-center">
        <div className="col-start-2 mt-22 flex flex-col gap-10 items-center text-center md:max-w-114 md:mt-0 xl:flex-row xl:max-w-none xl:text-start xl:gap-[336px]">
          <h2 className="text-(--c-white)">Sign up and Scoot off today</h2>
          <div className="flex items-center gap-3.5 xl:gap-4.5">
            ...
            >
              <title>Download on Apple App Store</title>
            ...
            <svg
              ...
              className="h-10 w-auto xl:h-14"
            >
              <title>Download on Google Play Store</title>
              <g fill="none" fill-rule="evenodd">
        ...
        <img
          ...
          alt=""
          className="absolute max-w-none bottom-0 -right-46"
        />
      </div>
      <div className="col-span-3 bg-(--c-jet-black) grid grid-cols-[inherit]">
        <div className="col-start-2 mt-16 flex flex-col gap-10 items-center text-center md:flex-row md:mt-0 md:gap-15">
          <Link to="/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="108"
          ...
          <nav>
            <ul className="text-(--c-dim-grey) flex flex-col items-center gap-4 md:flex-row md:gap-8">
              <li>
          ...
          <ul className="flex items-center gap-6 mt-[2.813rem] md:mt-0 md:ml-auto text-(--c-yellow)">
            <li>
              <Link to="" className="">
